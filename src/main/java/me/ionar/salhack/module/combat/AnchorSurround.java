...
public class AnchorSurround extends Module
{
    ...
    public AnchorSurround()
    {
        super("AnchorSurround", new String[]
                { "AS" }, "Automatically surrounds you with END PORTALS in the four cardinal directions", "NONE", 0x5324DB, ModuleType.COMBAT);
    }
