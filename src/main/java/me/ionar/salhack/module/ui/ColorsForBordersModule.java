...
public final class ColorsForBordersModule extends Module
{
    // 0x9933b6d7
    ...
    public ColorsForBordersModule()
    {
        super("ColorsForBorders", new String[]
                { "ColorsForBorders", "ColorsForBorders" }, "Allows you to modify the GUI Colors", "NONE", -1, ModuleType.UI);
    }
}