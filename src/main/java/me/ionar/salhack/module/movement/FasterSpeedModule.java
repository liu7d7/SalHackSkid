...
public class FasterSpeedModule extends Module
{
    ...
    public final Value<Float> Multiplier = new Value<Float>("Multiplier", new String[] {"Mult"}, "Multiplication of vanilla speed", 0.25f, 0.0f, 1.0f, 0.05f);
